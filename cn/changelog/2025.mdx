...
为高激励任务（例如，在 Airdrop 或 Frontier 活动中）提供的奖励引入可选的锁仓功能。

- **触发：** 活动结束后，奖励将存入您的余额。
- **锁仓：** 通过资产页面将奖励锁定在智能合约中。
...
- **原因：** 该模块已完成其在当前产品路线图下的计划生命周期。停用支持系统精简和资源重新配置，以便于即将发布的新功能。
...
- **注意：** 用户在 Robotics Frontier 的过去贡献和奖励被保留，并可以在其贡献历史中查看。其他 Frontier 或平台功能不受影响。
...
- **注意：** 用户在 Crypto Frontier 的过去贡献和奖励被保留，并可以在其贡献历史中查看。其他 Frontier 或平台功能不受影响。
...
<div className="changelog-item" data-type="feature" data-month="oct">

## 4.0.0 2025 年 10 月 01 日
---
**可配置奖励活动现已上线 Frontiers，提供额外的高价值激励。**
...
- **奖励：** 总奖励池为 50,000,000 $XNY（带锁仓期），在任务完成和验证后分配。
...
---
**活动启动: Codatta Booster 活动 第一季 第 2 周**
...
---
**活动启动: Codatta Booster 活动 第一季 第 1 周**
