...
**Weight:** 10% | **Verifies "Humanity" & Reachability**

This dimension promotes Sybil resistance by verifying that the user is reachable and unique across multiple platforms.

```
R_Identity = 100 × (0.1 × isEmail + 0.1 × isX + 0.1 × isTG + 0.1 × isDiscord + 0.6 × R_Others)
```

- **Logic:** Users bind external accounts (Email, X/Twitter, Telegram, Discord).
- **Impact:** Each binding contributes 10 points to this sub-score.
- **Future Proofing:** `R_Others` is reserved for future integrations (currently 0), making the current effective max for this dimension 40 (contributing 4 points to the total Reputation).

### Login activity (R_Login)

**Weight:** 20% | **Rewards Consistency & Habit**
...
**Weight:** 30% | **Staking as Confidence**
...
- **Exchange Rate:** Every ~1,667 XNY staked adds 1 point to your final Total Reputation Score.
...
**Weight:** 40% | **The Core Value Driver**
...
- **Dynamics:** A new user starts with a sub-score of 20 (contributing 20 points to the total). High adoption rates push the score toward 100; high refusal rates push it toward 0.
