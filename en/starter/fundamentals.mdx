...
![Atomic → Data Asset → Dataset](/diagrams/data_assetify_model.png)
...
![One sample → two assets via different label bundles](/diagrams/pattern01_sample_multi_label.png)
...
![Cross-sample composite](/diagrams/pattern02_cross_sample.png)
...
![Label-on-label](/diagrams/pattern03_label_on_label.png)
